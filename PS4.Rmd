...
join <- left_join(spolls, endorsements_count, by="candidate_name")

library(ggplot2)
p <- ggplot(data=endorsements_count , aes(x=candidate_name, y=count)) +
...
wordcloud(Corpus_trump, min.freq = 1,           max.words=50, random.order=FALSE, rot.per=0.35,            colors=brewer.pal(8, "Dark2"))
