...
```{r tidy=TRUE}
#Define a new class. Inside the function the candidate choose which door
door_choice <- function(choice){
  if (choice == 1 )
  return(choice)
  if (choice == 2 )
  return(choice)
  ...
  door_select <- list(selection= choice)
  class(door_choice) <- "door"
  return(door_choice)
}
...
PlayGame <- function(door) {
  car <- sample(1:3,1)
  if (car == door) {
    print("Congrats you just won a ner CAR!")
  }
  else {
