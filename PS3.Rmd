...
#2 Crear Metodo.Function que sirve en el objeto door.  El argumento es la puerta que se selecciono
PlayGame <- function(door) {
  door_selected <- door$door_selected
  car <- sample(1:3,1)
  if (car == door_selected) {
...
#3 Validator. Esta function me va a crear el objeto door solo si es 1 2 3. Output=objeto con class door

new_door <- function(door_choice){
  if(!(door_choice %in% c(1,2,3))) {
